...
class ElevatorSystem:
    def __init__(self, num_of_elevators, num_of_floors, speed):
        ...
        self.floor_buttons = [FloorButton(floor, screen_width - 450, screen_height - (floor + 1) * (screen_height // num_of_floors), 50, screen_height // num_of_floors) for floor in range(num_of_floors)]  # שימה של הכפתורים
